    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_name', models.ImageField(default=0, upload_to='', verbose_name='课程数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('click_num', models.IntegerField(default=0, verbose_name='访问量')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('work_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.orginfo', verbose_name='讲师公司')),
            ],
            options={
                'verbose_name': '讲师信息',
