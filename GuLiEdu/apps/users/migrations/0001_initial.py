    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='https://8888666.top', verbose_name='图片链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('girll', '女'), ('boy', '男')], default='girl', max_length=20, verbose_name='用户性别')),
                ('address', models.CharField(blank=True, max_length=200, null=True, verbose_name='用户地址')),
                ('phone', models.CharField(blank=True, max_length=11, null=True, verbose_name='用户手机号码')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
